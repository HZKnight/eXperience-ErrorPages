                    ...
                    <table width="550" bgcolor="#6699ff" border="0" align="center" cellspacing="1" cellpadding="5" color="#000000" id="box">
                        <tr>
                            <td class="side" valign="top">
                                <img src="./img/error.png" alt="error" width="70px" />
                            </td>
                            <td bgcolor="#ffffff">
                                <center>
                                    <span style="font-weight: 600; color: #CC0000;">
                                        <img src ='./img/logo.png' alt='$nomesito'>
                                        <br />
                                        Errore <?=$result?>
                                    </span>
                                    <br />
                                ...
                                <div style="width:100%; text-align:right;"> 
                                    <a href="<?=$ritornahome?>" class="button white"><img src="img/home.png" width="16px" /> Vai alla Home Page</a>
                                </div>
